...
public class MyMinecraftNukeRegistry {
    ...
    public void dequeueExplosion(MyMinecraftNukeExplosion explosion)
    {
    ...
    public static void unregisterExplosion(MyMinecraftNukeExplosion explosion)
    {
        INSTANCE.dequeueExplosion(explosion);
    }
    */
