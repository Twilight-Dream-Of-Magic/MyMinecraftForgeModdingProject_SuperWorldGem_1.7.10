...
public class LoadTopSuperWorldAxe extends Item {
	...
	public static final Item.ToolMaterial SPUERWORLDTOPAXE = EnumHelper.addToolMaterial("SPUERWORLDTOPAXE", 16, 102400, 5120000F, 5120000F, 16);
	public static Item TopSuperWorldAxe = new ItemToolTopSuperWorldAxe(SPUERWORLDTOPAXE, "TopSuperWorldAxe");
	
	/*
	static {
		final int setHarvestLevel = 16; // Harvest level
		//ToolMaterial SPUERWORLDTOPAXE = EnumHelper.addToolMaterial("SPUERWORLDTOPAXE", 16, 102400, 5120000F, 5120000F, 16);
		TopSuperWorldAxe = new ItemAxe(SPUERWORLDTOPAXE) {
			public Set<String> getToolClasses(ItemStack stack) {
				HashMap<String, Integer> returnValue = new HashMap<String, Integer>();
				returnValue.put("axe", setHarvestLevel);
				returnValue.put("SPUERWORLDTOPAXE",setHarvestLevel);
	...
	*/
	...
	public static class ItemToolTopSuperWorldAxe extends ItemAxe {
		...
		protected ItemToolTopSuperWorldAxe(Item.ToolMaterial SPUERWORLDTOPAXE,String unlocalizedName)
		{
		  ...
		  this.setHarvestLevel("axe",16);
		  this.setHarvestLevel("SPUERWORLDTOPAXE",16);
