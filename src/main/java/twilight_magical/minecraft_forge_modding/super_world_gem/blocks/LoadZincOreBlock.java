...
public class LoadZincOreBlock extends Block {
	
	public LoadZincOreBlock (String unlocalizedName, Material material, float hardness, float resistance) {
		super(material);
		this.setBlockName(unlocalizedName);
		this.setCreativeTab(CreativeTabs.tabBlock);
		this.setHardness(hardness);
		this.setBlockTextureName("super_world_gem_forge_mod:(Zn) Zinc Ore - [SuperWorldGemMod]");
		this.setHarvestLevel("pickaxe",4);
		this.setHarvestLevel("SPUERWORLDTOPPICKAXE",8);
		this.setHarvestLevel("SPUERWORLDTOPBLOCKBREAKER", 8);
	}

	public LoadZincOreBlock(String unlocalizedName, float hardness, float resistance) {
	...
	public LoadZincOreBlock(String unlocalizedName) {
		this(unlocalizedName, 16.0f, 0.25f);
	}
